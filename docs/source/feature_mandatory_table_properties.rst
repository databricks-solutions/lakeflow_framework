...
| **Scope: Global**
| Mandatory table properties are defined in the global configuration file located at ``src/lakeflow_framework/config/default/global.json|yaml`` under the ``mandatory_table_properties`` section.
