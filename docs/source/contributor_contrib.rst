...
5. **Open a pull request**
   ...
   Follow the standard PR process in :doc:`contributor_dev_steps`.  In the PR
   description, note:
...
- :doc:`contributor_dev_steps` — general contribution workflow.
- :doc:`contributor_dev_env` — development environment setup.
