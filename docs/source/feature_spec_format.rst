...
| **Scope: Framework**
| The global specification format is defined in the Framework's global configuration file: ``src/lakeflow_framework/config/default/global.json|yaml``
...
**Framework Configuration** (``src/lakeflow_framework/config/default/global.json|yaml``):
