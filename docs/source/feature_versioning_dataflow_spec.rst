...
``src/lakeflow_framework/config/default/dataflow_spec_mapping/[version]/dataflow_spec_mapping.json``
...
2. Each mapping version should be stored in its own directory under ``src/lakeflow_framework/config/default/dataflow_spec_mapping/``
