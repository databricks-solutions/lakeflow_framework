...
| **Scope: Global**
| In the Framework bundle, substitutions are defined in the following configuration file: ``src/lakeflow_framework/config/default/<deployment environment/target>_substitutions.json|yaml``
| e.g. ``src/lakeflow_framework/config/default/dev_substitutions.json|yaml``
