Creating a Nodester Data Flow Spec Reference
############################################

The **Nodester** Data Flow Spec describes a pipeline as a graph of nodes that
chain together:
...
Nodester spec is a flat list of nodes that reads top-to-bottom in the order the
data flows. The framework converts a Nodester spec into its internal flow-based
...
**Casing.** Nodester specs use ``snake_case`` field names.
...
.. code-block:: json
   ...
   {
       "data_flow_id": "nodester_customer_simple",
       "data_flow_group": "nodester_base_samples",
...
.. code-block:: json
   ...
   {
       "data_flow_id": "nodester_customer_enriched",
       "data_flow_group": "nodester_base_samples",
       "data_flow_type": "nodester",
       "nodes": [
           {
...
.. _dataflow-spec-nodester-source-nodes:
...
.. _dataflow-spec-nodester-transformation-nodes:
...
.. _dataflow-spec-nodester-target-nodes:
...
.. _dataflow-spec-nodester-conversion:

How Nodester specs are converted
================================
