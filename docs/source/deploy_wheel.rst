...
deployment modes, see :doc:`deploy_framework_options`.
...
See :ref:`config-resolution-order` in :doc:`feature_framework_configuration`
for the full table.
...
- :doc:`deploy_framework_options` — deployment modes overview and flat DAB deploy
- :doc:`deploy_local_framework` — deploy the framework via DAB from your laptop
- :doc:`feature_framework_configuration` — full config resolution reference
