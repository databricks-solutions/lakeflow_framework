# ADR-0007: `lakeflow_framework` pip-installable package
...
See `docs/decisions/0007-*` (this file) for the publish model and
...
- Existing flat-deploy customers are unaffected: the `src/` shims preserve
  ...
  (ADR-0008) means behaviour is identical to pre-v0.16.0.
