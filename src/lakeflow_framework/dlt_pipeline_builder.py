...
from lakeflow_framework.config_resolver import load_framework_config, resolve_framework_config_path
...
from lakeflow_framework.dataflow_spec_builder import DataflowSpecBuilder
...
import lakeflow_framework.logger as pipeline_logger
...
class DLTPipelineBuilder:
    ...
    def _load_framework_global_config(self) -> Dict[str, Any]:
        ...
        from lakeflow_framework.config_resolver import load_framework_config
