...
The Framework comes with extensive samples that demonstrate the use of the framework and Lakeflow concepts. **These legacy bundles** are organised as follows:
...
1. Navigate to the legacy samples directory in the root of the Framework repository:
