...
if ! update_substitutions_file "feature_samples/src/pipeline_configs/dev_substitutions.json"; then
...
if ! update_pipeline_global_config_file "feature_samples/src/pipeline_configs/global.json"; then
    log_error "Failed to update pipeline global config file. Exiting."
    exit 1
fi

# Change to feature_samples directory for deployment
cd feature_samples
...
restore_substitutions_file "feature_samples/src/pipeline_configs/dev_substitutions.json"
restore_pipeline_global_config_file "feature_samples/src/pipeline_configs/global.json"
