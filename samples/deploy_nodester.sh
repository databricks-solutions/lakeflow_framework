#!/bin/bash
# Nodester Sample Bundle Deployment

# Sample-specific constants
BUNDLE_NAME="Nodester Sample Bundle"
...
if ! update_substitutions_file "nodester_sample/src/pipeline_configs/dev_substitutions.json"; then
    log_error "Failed to update substitutions file. Exiting."
    exit 1
fi

# Change to nodester_sample directory for deployment
cd nodester_sample
...
restore_substitutions_file "nodester_sample/src/pipeline_configs/dev_substitutions.json"
