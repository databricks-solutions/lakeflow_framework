#!/bin/bash
# Nodespec Sample Bundle Deployment

# Sample-specific constants
BUNDLE_NAME="Nodespec Sample Bundle"
...
if ! update_substitutions_file "nodespec_sample/src/pipeline_configs/dev_substitutions.json"; then
    log_error "Failed to update substitutions file. Exiting."
    exit 1
fi

# Change to nodespec_sample directory for deployment
cd nodespec_sample
...
restore_substitutions_file "nodespec_sample/src/pipeline_configs/dev_substitutions.json"
